...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-fastly/releases) for this repository*
...
## 3.11.0 (2021-12-20)
* Upgrade to v0.39.0 of the Fastly Terraform Provider
...
## 3.8.0 (2021-10-19)
* Upgrade to v0.36.0 of the Fastly Terraform Provider

## 3.7.0 (2021-09-27)
* Upgrade to v0.35.0 of the Fastly Terraform Provider

## 3.6.0 (2021-08-12)
* Upgrade to v0.34.0 of the Fastly Terraform Provider

## 3.5.0 (2021-08-03)
* Upgrade to v0.33.0 of the Fastly Terraform Provider

## 3.4.0 (2021-07-12)
* Upgrade to v0.32.0 of the Fastly Terraform Provider

## 3.3.0 (2021-05-27)
* Upgrade to v3.2.1 of the pulumi-terraform-bridge

## 3.2.0 (2021-05-21)
* Upgrade to v0.30.0 of the Fastly Terraform Provider
