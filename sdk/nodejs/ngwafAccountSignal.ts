 ...
 * ```
 */
export class NgwafAccountSignal extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NgwafAccountSignalState, opts?: pulumi.CustomResourceOptions): NgwafAccountSignal {
        return new NgwafAccountSignal(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fastly:index/ngwafAccountSignal:NgwafAccountSignal';

    /**
     * Returns true if the given object is an instance of NgwafAccountSignal.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NgwafAccountSignal {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NgwafAccountSignal.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: NgwafAccountSignalArgs | NgwafAccountSignalState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NgwafAccountSignalState | undefined;
            resourceInputs["appliesTos"] = state?.appliesTos;
            resourceInputs["description"] = state?.description;
            resourceInputs["name"] = state?.name;
            resourceInputs["referenceId"] = state?.referenceId;
        } else {
            const args = argsOrState as NgwafAccountSignalArgs | undefined;
        ...
        super(NgwafAccountSignal.__pulumiType, name, resourceInputs, opts);
    }
}
