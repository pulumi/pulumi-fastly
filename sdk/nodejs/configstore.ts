...
export class Configstore extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConfigstoreState, opts?: pulumi.CustomResourceOptions): Configstore {
        return new Configstore(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fastly:index/configstore:Configstore';

    /**
     * Returns true if the given object is an instance of Configstore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Configstore {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Configstore.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: ConfigstoreArgs | ConfigstoreState, opts?: pulumi.CustomResourceOptions) {
