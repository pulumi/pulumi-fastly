...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] login: The email address, which is the login name, of the User
        :param pulumi.Input[builtins.str] name: The real life name of the user
        :param pulumi.Input[builtins.str] role: The role of this user. Can be `user` (the default), `billing`, `engineer`, or `superuser`. For detailed information on the abilities granted to each role, see [Fastly's Documentation on User roles](https://docs.fastly.com/en/guides/configuring-user-roles-and-permissions#user-roles-and-what-they-can-do)
        """
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            login: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'User':
        """
