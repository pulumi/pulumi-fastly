...
def get_package_hash(content: Optional[builtins.str] = None,
...
def get_package_hash_output(content: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            filename: Optional[pulumi.Input[Optional[builtins.str]]] = None,
