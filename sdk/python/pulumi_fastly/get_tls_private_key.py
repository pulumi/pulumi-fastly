...
class GetTlsPrivateKeyResult:
    ...
    def public_key_sha1(self) -> _builtins.str:
        """
...
def get_tls_private_key(created_at: Optional[_builtins.str] = None,
                        id: Optional[_builtins.str] = None,
                        key_length: Optional[_builtins.int] = None,
                        key_type: Optional[_builtins.str] = None,
                        name: Optional[_builtins.str] = None,
                        public_key_sha1: Optional[_builtins.str] = None,
    ...
    :param _builtins.str created_at: Timestamp (GMT) when the private key was created.
    :param _builtins.str id: Fastly private key ID. Conflicts with all the other filters
    :param _builtins.int key_length: The key length used to generate the private key.
    :param _builtins.str key_type: The algorithm used to generate the private key. Must be RSA.
    :param _builtins.str name: The human-readable name assigned to the private key when uploaded.
    :param _builtins.str public_key_sha1: A hash of the associated public key, useful for safely identifying it.
    """
    __args__ = dict()
