...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 force_http2: Optional[pulumi.Input[builtins.bool]] = None,
                 no_auth: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] api_key: Fastly API Key from https://app.fastly.com/#account
        :param pulumi.Input[builtins.str] base_url: Fastly API URL
        :param pulumi.Input[builtins.bool] force_http2: Set this to `true` to disable HTTP/1.x fallback mechanism that the underlying Go library will attempt upon connection to
        ...
        :param pulumi.Input[builtins.bool] no_auth: Set to `true` if your configuration only consumes data sources that do not require authentication, such as
    ...
    def force_http2(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @force_http2.setter
    def force_http2(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "force_http2", value)

    @property
    @pulumi.getter(name="noAuth")
    def no_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @no_auth.setter
    def no_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
