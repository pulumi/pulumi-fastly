...
class ConfigstoreEntriesArgs:
    def __init__(__self__, *,
                 entries: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
                 store_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] entries: A map representing an entry in the Config Store, (key/value)
        :param pulumi.Input[builtins.str] store_id: An alphanumeric string identifying the Config Store.
        """
    ...
    @property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        pulumi.set(self, "entries", value)

    @property
    @pulumi.getter(name="storeId")
    def store_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @store_id.setter
    def store_id(self, value: pulumi.Input[builtins.str]):
...
class _ConfigstoreEntriesState:
    def __init__(__self__, *,
                 entries: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 manage_entries: Optional[pulumi.Input[builtins.bool]] = None,
                 store_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def entries(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map representing an entry in the Config Store, (key/value)
        """
        return pulumi.get(self, "entries")
    ...
    @entries.setter
    def entries(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "entries", value)
    ...
    @property
    @pulumi.getter(name="storeId")
    def store_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An alphanumeric string identifying the Config Store.
        """
        return pulumi.get(self, "store_id")
    ...
    @store_id.setter
    def store_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "store_id", value)
...
class ConfigstoreEntries(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entries: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            manage_entries: Optional[pulumi.Input[builtins.bool]] = None,
            store_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ConfigstoreEntries':
        """
    ...
    @property
    @pulumi.getter
    def entries(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        A map representing an entry in the Config Store, (key/value)
        """
        return pulumi.get(self, "entries")
    ...
    @property
    @pulumi.getter(name="storeId")
    def store_id(self) -> pulumi.Output[builtins.str]:
        """
        An alphanumeric string identifying the Config Store.
        """
        return pulumi.get(self, "store_id")
