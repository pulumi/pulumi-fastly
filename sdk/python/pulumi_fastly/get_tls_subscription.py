...
def get_tls_subscription(certificate_authority: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_authority: The entity that issues and certifies the TLS certificates for the subscription.
    :param _builtins.str configuration_id: ID of TLS configuration used to terminate TLS traffic.
    :param Sequence[_builtins.str] domains: List of domains on which to enable TLS.
    :param _builtins.str id: ID of TLS subscription. Conflicts with all the other filters.
    """
    __args__ = dict()
