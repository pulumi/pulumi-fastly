...
def get_tls_subscription(certificate_authority: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_authority: The entity that issues and certifies the TLS certificates for the subscription.
    :param builtins.str configuration_id: ID of TLS configuration used to terminate TLS traffic.
    :param Sequence[builtins.str] domains: List of domains on which to enable TLS.
    :param builtins.str id: ID of TLS subscription. Conflicts with all the other filters.
    """
    __args__ = dict()
...
def get_tls_subscription_output(certificate_authority: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                configuration_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                domains: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
