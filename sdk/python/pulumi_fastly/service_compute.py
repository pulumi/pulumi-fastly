...
class ServiceCompute(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            package = _utilities.configure(package, ServiceComputePackageArgs, True)
            __props__.__dict__["package"] = package
            product_enablement = _utilities.configure(product_enablement, ServiceComputeProductEnablementArgs, True)
