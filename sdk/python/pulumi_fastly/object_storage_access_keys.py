...
class ObjectStorageAccessKeysArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: The description of the access key
        :param pulumi.Input[str] permission: The permissions of the access key
        :param pulumi.Input[Sequence[pulumi.Input[str]]] buckets: Optional list of buckets the access key will be associated with.  Example: `["bucket1", "bucket2"]`
        """
...
class _ObjectStorageAccessKeysState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] access_key_id: ID for the object storage access token
        :param pulumi.Input[Sequence[pulumi.Input[str]]] buckets: Optional list of buckets the access key will be associated with.  Example: `["bucket1", "bucket2"]`
        :param pulumi.Input[str] description: The description of the access key
        :param pulumi.Input[str] permission: The permissions of the access key
        :param pulumi.Input[str] secret_key: Secret key for the object storage access token
        """
...
class ObjectStorageAccessKeys(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            permission: Optional[pulumi.Input[str]] = None,
            secret_key: Optional[pulumi.Input[str]] = None) -> 'ObjectStorageAccessKeys':
        """
    ...
    @property
    @pulumi.getter
    def buckets(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        Optional list of buckets the access key will be associated with.  Example: `["bucket1", "bucket2"]`
        """
        return pulumi.get(self, "buckets")
