...
class TlsActivationArgs:
    def __init__(__self__, *,
                 ...
                 mutual_authentication_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TlsActivation resource.
        :param pulumi.Input[builtins.str] certificate_id: ID of certificate to use. Must have the `domain` specified in the certificate's Subject Alternative Names.
        :param pulumi.Input[builtins.str] domain: Domain to enable TLS on. Must be assigned to an existing Fastly Service.
        :param pulumi.Input[builtins.str] configuration_id: ID of TLS configuration to be used to terminate TLS traffic, or use the default one if missing.
        :param pulumi.Input[builtins.str] mutual_authentication_id: An alphanumeric string identifying a mutual authentication.
        """
    ...
    def mutual_authentication_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mutual_authentication_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TlsActivationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: ID of certificate to use. Must have the `domain` specified in the certificate's Subject Alternative Names.
        :param pulumi.Input[builtins.str] configuration_id: ID of TLS configuration to be used to terminate TLS traffic, or use the default one if missing.
        :param pulumi.Input[builtins.str] created_at: Time-stamp (GMT) when TLS was enabled.
        :param pulumi.Input[builtins.str] domain: Domain to enable TLS on. Must be assigned to an existing Fastly Service.
        :param pulumi.Input[builtins.str] mutual_authentication_id: An alphanumeric string identifying a mutual authentication.
        """
...
class TlsActivation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            created_at: Optional[pulumi.Input[builtins.str]] = None,
            domain: Optional[pulumi.Input[builtins.str]] = None,
            mutual_authentication_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsActivation':
        """
    ...
    @property
    @pulumi.getter(name="mutualAuthenticationId")
    def mutual_authentication_id(self) -> pulumi.Output[builtins.str]:
        """
        An alphanumeric string identifying a mutual authentication.
        """
        return pulumi.get(self, "mutual_authentication_id")
