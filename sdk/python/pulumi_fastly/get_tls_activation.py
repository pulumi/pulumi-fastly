...
def get_tls_activation(certificate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_id: ID of the TLS Certificate used.
    :param _builtins.str configuration_id: ID of the TLS Configuration used.
    :param _builtins.str domain: Domain that TLS was enabled on.
    :param _builtins.str id: Fastly Activation ID. Conflicts with all other filters.
    """
    __args__ = dict()
