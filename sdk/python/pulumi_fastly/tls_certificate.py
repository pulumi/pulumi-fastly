...
class TlsCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_body: PEM-formatted certificate, optionally including any intermediary certificates.
        :param pulumi.Input[builtins.str] name: Human-readable name used to identify the certificate. Defaults to the certificate's Common Name or first Subject Alternative Name entry.
        """
...
class _TlsCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: All the domains (including wildcard domains) that are listed in the certificate's Subject Alternative Names (SAN) list.
        :param pulumi.Input[builtins.str] issued_to: The hostname for which a certificate was issued.
        ...
        :param pulumi.Input[builtins.str] serial_number: A value assigned by the issuer that is unique to a certificate.
        :param pulumi.Input[builtins.str] signature_algorithm: The algorithm used to sign the certificate.
...
class TlsCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            serial_number: Optional[pulumi.Input[builtins.str]] = None,
            signature_algorithm: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsCertificate':
        """
