...
class _TlsCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] issued_to: The hostname for which a certificate was issued.
        ...
        :param pulumi.Input[_builtins.str] serial_number: A value assigned by the issuer that is unique to a certificate.
        :param pulumi.Input[_builtins.str] signature_algorithm: The algorithm used to sign the certificate.
...
class TlsCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            serial_number: Optional[pulumi.Input[_builtins.str]] = None,
            signature_algorithm: Optional[pulumi.Input[_builtins.str]] = None,
            updated_at: Optional[pulumi.Input[_builtins.str]] = None) -> 'TlsCertificate':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="issuedTo")
    def issued_to(self) -> pulumi.Output[_builtins.str]:
        """
        The hostname for which a certificate was issued.
        """
        return pulumi.get(self, "issued_to")
