...
class TlsPlatformCertificateArgs:
    def __init__(__self__, *,
                 ...
                 intermediates_blob: pulumi.Input[builtins.str],
                 allow_untrusted_root: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a TlsPlatformCertificate resource.
        :param pulumi.Input[builtins.str] certificate_body: PEM-formatted certificate.
        :param pulumi.Input[builtins.str] configuration_id: ID of TLS configuration to be used to terminate TLS traffic.
        :param pulumi.Input[builtins.str] intermediates_blob: PEM-formatted certificate chain from the `certificate_body` to its root.
        :param pulumi.Input[builtins.bool] allow_untrusted_root: Disable checking whether the root of the certificate chain is trusted. Useful for development purposes to allow use of self-signed CAs. Defaults to false. Write-only on create.
        """
    ...
    def intermediates_blob(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def intermediates_blob(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "intermediates_blob", value)

    @property
    @pulumi.getter(name="allowUntrustedRoot")
    def allow_untrusted_root(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_untrusted_root(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TlsPlatformCertificateState:
    def __init__(__self__, *,
                 ...
                 intermediates_blob: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] certificate_body: PEM-formatted certificate.
        :param pulumi.Input[builtins.str] configuration_id: ID of TLS configuration to be used to terminate TLS traffic.
        :param pulumi.Input[builtins.str] created_at: Timestamp (GMT) when the certificate was created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: All the domains (including wildcard domains) that are listed in any certificate's Subject Alternative Names (SAN) list.
        :param pulumi.Input[builtins.str] intermediates_blob: PEM-formatted certificate chain from the `certificate_body` to its root.
        :param pulumi.Input[builtins.str] not_after: Timestamp (GMT) when the certificate will expire.
        :param pulumi.Input[builtins.str] not_before: Timestamp (GMT) when the certificate will become valid.
        :param pulumi.Input[builtins.bool] replace: A recommendation from Fastly indicating the key associated with this certificate is in need of rotation.
        :param pulumi.Input[builtins.str] updated_at: Timestamp (GMT) when the certificate was last updated.
        """
        if allow_untrusted_root is not None:
            pulumi.set(__self__, "allow_untrusted_root", allow_untrusted_root)
    ...
    @property
    @pulumi.getter(name="intermediatesBlob")
    def intermediates_blob(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        PEM-formatted certificate chain from the `certificate_body` to its root.
        """
        return pulumi.get(self, "intermediates_blob")
    ...
    @intermediates_blob.setter
    def intermediates_blob(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "intermediates_blob", value)
...
@pulumi.type_token("fastly:index/tlsPlatformCertificate:TlsPlatformCertificate")
class TlsPlatformCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            not_before: Optional[pulumi.Input[builtins.str]] = None,
            replace: Optional[pulumi.Input[builtins.bool]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsPlatformCertificate':
        """
    ...
    @property
    @pulumi.getter(name="allowUntrustedRoot")
    def allow_untrusted_root(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disable checking whether the root of the certificate chain is trusted. Useful for development purposes to allow use of self-signed CAs. Defaults to false. Write-only on create.
        """
        return pulumi.get(self, "allow_untrusted_root")
    ...
    @property
    @pulumi.getter(name="intermediatesBlob")
    def intermediates_blob(self) -> pulumi.Output[builtins.str]:
        """
        PEM-formatted certificate chain from the `certificate_body` to its root.
        """
        return pulumi.get(self, "intermediates_blob")
    ...
    @property
    @pulumi.getter
    def replace(self) -> pulumi.Output[builtins.bool]:
        """
        A recommendation from Fastly indicating the key associated with this certificate is in need of rotation.
        """
        return pulumi.get(self, "replace")
