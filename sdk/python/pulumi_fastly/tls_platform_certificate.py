...
class TlsPlatformCertificateArgs:
    ...
    def intermediates_blob(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def intermediates_blob(self, value: pulumi.Input[_builtins.str]):
...
class _TlsPlatformCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] domains: All the domains (including wildcard domains) that are listed in any certificate's Subject Alternative Names (SAN) list.
        :param pulumi.Input[_builtins.str] intermediates_blob: PEM-formatted certificate chain from the `certificate_body` to its root.
        :param pulumi.Input[_builtins.str] not_after: Timestamp (GMT) when the certificate will expire.
        :param pulumi.Input[_builtins.str] not_before: Timestamp (GMT) when the certificate will become valid.
        :param pulumi.Input[_builtins.bool] replace: A recommendation from Fastly indicating the key associated with this certificate is in need of rotation.
        :param pulumi.Input[_builtins.str] updated_at: Timestamp (GMT) when the certificate was last updated.
        """
        if allow_untrusted_root is not None:
            pulumi.set(__self__, "allow_untrusted_root", allow_untrusted_root)
...
class TlsPlatformCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ca_key = tls.PrivateKey("ca_key", algorithm="RSA")
        ...
        cert = tls.LocallySignedCert("cert",
    ...
    @_builtins.property
    @pulumi.getter(name="allowUntrustedRoot")
    def allow_untrusted_root(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Disable checking whether the root of the certificate chain is trusted. Useful for development purposes to allow use of self-signed CAs. Defaults to false. Write-only on create.
        """
        return pulumi.get(self, "allow_untrusted_root")
    ...
    @_builtins.property
    @pulumi.getter(name="intermediatesBlob")
    def intermediates_blob(self) -> pulumi.Output[_builtins.str]:
        """
        PEM-formatted certificate chain from the `certificate_body` to its root.
        """
        return pulumi.get(self, "intermediates_blob")
