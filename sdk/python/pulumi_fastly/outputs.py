...
class ServiceVclLoggingCloudfile(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str path: The path to upload logs to
        :param builtins.int period: How frequently log files are finalized so they can be available for reading (in seconds, default `3600`)
        :param builtins.str placement: Where in the generated VCL the logging call should be placed. Can be `none` or `waf_debug`.
        :param builtins.str public_key: The PGP public key that Fastly will use to encrypt your log files before writing them to disk
        :param builtins.str region: The region to stream logs to. One of: DFW (Dallas), ORD (Chicago), IAD (Northern Virginia), LON (London), SYD (Sydney), HKG (Hong Kong)
...
class ServiceVclWaf(dict):
    ...
    def __init__(__self__, *,
                 response_object: builtins.str,
                 disabled: Optional[builtins.bool] = None,
                 prefetch_condition: Optional[builtins.str] = None,
                 waf_id: Optional[builtins.str] = None):
        """
        :param builtins.str response_object: The name of the response object used by the Web Application Firewall
        :param builtins.bool disabled: A flag used to completely disable a Web Application Firewall. This is intended to only be used in an emergency
        :param builtins.str prefetch_condition: The `condition` to determine which requests will be run past your Fastly WAF. This `condition` must be of type `PREFETCH`. For detailed information about Conditionals, see [Fastly's Documentation on Conditionals](https://docs.fastly.com/en/guides/using-conditions)
        :param builtins.str waf_id: The ID of the WAF
        """
    ...
    def response_object(self) -> builtins.str:
        """
    ...
    def prefetch_condition(self) -> Optional[builtins.str]:
        """
    ...
    def waf_id(self) -> Optional[builtins.str]:
        """
        The ID of the WAF
        """
...
class ServiceWafConfigurationRule(dict):
    ...
    def __init__(__self__, *,
                 modsec_rule_id: builtins.int,
                 status: builtins.str,
                 revision: Optional[builtins.int] = None):
        """
        :param builtins.int modsec_rule_id: The Web Application Firewall rule's modsecurity ID
        :param builtins.str status: The Web Application Firewall rule's status. Allowed values are (`log`, `block` and `score`)
        :param builtins.int revision: The Web Application Firewall rule's revision. The latest revision will be used if this is not provided
        """
    ...
    def modsec_rule_id(self) -> builtins.int:
        """
...
class ServiceWafConfigurationRuleExclusion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 modsec_rule_ids: Optional[Sequence[builtins.int]] = None,
                 number: Optional[builtins.int] = None):
        """
        :param builtins.str condition: A conditional expression in VCL used to determine if the condition is met
        :param builtins.str exclusion_type: The type of rule exclusion. Values are `rule` to exclude the specified rule(s), or `waf` to disable the Web Application Firewall
        :param builtins.str name: The name of rule exclusion
        :param Sequence[builtins.int] modsec_rule_ids: Set of modsecurity IDs to be excluded. No rules should be provided when `exclusion_type` is `waf`. The rules need to be configured on the Web Application Firewall to be excluded
        :param builtins.int number: The numeric ID assigned to the WAF Rule Exclusion
        """
    ...
    def modsec_rule_ids(self) -> Optional[Sequence[builtins.int]]:
        """
...
class GetWafRulesRuleResult(dict):
    def __init__(__self__, *,
                 latest_revision_number: builtins.int,
                 modsec_rule_id: builtins.int,
                 type: builtins.str):
        """
        :param builtins.int latest_revision_number: The modsecurity rule's latest revision.
        :param builtins.int modsec_rule_id: The modsecurity rule ID.
        :param builtins.str type: The modsecurity rule's type.
        """
    ...
    def latest_revision_number(self) -> builtins.int:
        """
