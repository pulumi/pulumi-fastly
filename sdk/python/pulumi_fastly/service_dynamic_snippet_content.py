...
class ServiceDynamicSnippetContentArgs:
    def __init__(__self__, *,
                 ...
                 snippet_id: pulumi.Input[builtins.str],
                 manage_snippets: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] service_id: The ID of the service that the dynamic snippet belongs to
        :param pulumi.Input[builtins.str] snippet_id: The ID of the dynamic snippet that the content belong to
        :param pulumi.Input[builtins.bool] manage_snippets: Whether to reapply changes if the state of the snippets drifts, i.e. if snippets are managed externally
        """
    ...
    def snippet_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @snippet_id.setter
    def snippet_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "snippet_id", value)

    @property
    @pulumi.getter(name="manageSnippets")
    def manage_snippets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def manage_snippets(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ServiceDynamicSnippetContent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            manage_snippets: Optional[pulumi.Input[builtins.bool]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            snippet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceDynamicSnippetContent':
        """
    ...
    @property
    @pulumi.getter(name="manageSnippets")
    def manage_snippets(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to reapply changes if the state of the snippets drifts, i.e. if snippets are managed externally
        """
        return pulumi.get(self, "manage_snippets")
    ...
    @property
    @pulumi.getter(name="snippetId")
    def snippet_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the dynamic snippet that the content belong to
        """
        return pulumi.get(self, "snippet_id")
