...
class GetWafRulesResult:
    ...
    def exclude_modsec_rule_ids(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    @property
    @pulumi.getter
    def publishers(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_waf_rules(exclude_modsec_rule_ids: Optional[Sequence[builtins.int]] = None,
                  modsec_rule_ids: Optional[Sequence[builtins.int]] = None,
                  publishers: Optional[Sequence[builtins.str]] = None,
                  tags: Optional[Sequence[builtins.str]] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWafRulesResult:
    """
    Use this data source to access information about an existing resource.

    :param Sequence[builtins.int] exclude_modsec_rule_ids: Exclusion filter by WAF rule's ModSecurity ID.
    :param Sequence[builtins.int] modsec_rule_ids: A list of modsecurity rules IDs to be used as filters for the data set.
    :param Sequence[builtins.str] publishers: Inclusion filter by WAF rule's publishers.
    :param Sequence[builtins.str] tags: Inclusion filter by WAF rule's tags.
    """
    __args__ = dict()
...
def get_waf_rules_output(exclude_modsec_rule_ids: Optional[pulumi.Input[Optional[Sequence[builtins.int]]]] = None,
                         modsec_rule_ids: Optional[pulumi.Input[Optional[Sequence[builtins.int]]]] = None,
                         publishers: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
