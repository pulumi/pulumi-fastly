...
class AlertArgs:
    def __init__(__self__, *,
                 ...
                 integration_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] metric: The metric name to alert on for a specific source: [domains](https://developer.fastly.com/reference/api/metrics-stats/domain-inspector/historical), [origins](https://developer.fastly.com/reference/api/metrics-stats/origin-inspector/historical), or [stats](https://developer.fastly.com/reference/api/metrics-stats/historical-stats).
        :param pulumi.Input[builtins.str] source: The source where the metric comes from. One of: `domains`, `origins`, `stats`.
        :param pulumi.Input[builtins.str] description: Additional text that is included in the alert notification.
        :param pulumi.Input['AlertDimensionsArgs'] dimensions: More filters depending on the source type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] integration_ids: List of integrations used to notify when alert fires.
        :param pulumi.Input[builtins.str] name: The name of the alert.
        :param pulumi.Input[builtins.str] service_id: The service which the alert monitors. Optional when using `stats` as the `source`.
        """
    ...
    def integration_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def integration_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Alert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None) -> 'Alert':
        """
    ...
    @property
    @pulumi.getter(name="integrationIds")
    def integration_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of integrations used to notify when alert fires.
        """
        return pulumi.get(self, "integration_ids")
