...
class TlsMutualAuthenticationArgs:
    def __init__(__self__, *,
                 cert_bundle: pulumi.Input[builtins.str],
                 activation_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] cert_bundle: One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] activation_ids: List of TLS Activation IDs
        :param pulumi.Input[builtins.bool] enforced: Determines whether Mutual TLS will fail closed (enforced) or fail open. A true value will require a successful Mutual TLS handshake for the connection to continue and will fail closed if unsuccessful. A false value will fail open and allow the connection to proceed (if this attribute is not set we default to `false`).
        :param pulumi.Input[builtins.str] name: A custom name for your mutual authentication. If name is not supplied we will auto-generate one.
        """
    ...
    def cert_bundle(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cert_bundle.setter
    def cert_bundle(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cert_bundle", value)

    @property
    @pulumi.getter(name="activationIds")
    def activation_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def activation_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _TlsMutualAuthenticationState:
    def __init__(__self__, *,
                 activation_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cert_bundle: Optional[pulumi.Input[builtins.str]] = None,
                 created_at: Optional[pulumi.Input[builtins.str]] = None,
                 enforced: Optional[pulumi.Input[builtins.bool]] = None,
                 include: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tls_activations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 updated_at: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering TlsMutualAuthentication resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] activation_ids: List of TLS Activation IDs
        :param pulumi.Input[builtins.str] cert_bundle: One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted.
        :param pulumi.Input[builtins.str] created_at: Date and time in ISO 8601 format.
        :param pulumi.Input[builtins.bool] enforced: Determines whether Mutual TLS will fail closed (enforced) or fail open. A true value will require a successful Mutual TLS handshake for the connection to continue and will fail closed if unsuccessful. A false value will fail open and allow the connection to proceed (if this attribute is not set we default to `false`).
        :param pulumi.Input[builtins.str] name: A custom name for your mutual authentication. If name is not supplied we will auto-generate one.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tls_activations: List of alphanumeric strings identifying TLS activations.
        :param pulumi.Input[builtins.str] updated_at: Date and time in ISO 8601 format.
        """
        if activation_ids is not None:
            pulumi.set(__self__, "activation_ids", activation_ids)
    ...
    @property
    @pulumi.getter(name="certBundle")
    def cert_bundle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted.
        """
        return pulumi.get(self, "cert_bundle")
    ...
    @cert_bundle.setter
    def cert_bundle(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cert_bundle", value)
    ...
    def tls_activations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def tls_activations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("fastly:index/tlsMutualAuthentication:TlsMutualAuthentication")
class TlsMutualAuthentication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tls_activations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsMutualAuthentication':
        """
    ...
    @property
    @pulumi.getter(name="activationIds")
    def activation_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of TLS Activation IDs
        """
        return pulumi.get(self, "activation_ids")
    ...
    @property
    @pulumi.getter(name="certBundle")
    def cert_bundle(self) -> pulumi.Output[builtins.str]:
        """
        One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted.
        """
        return pulumi.get(self, "cert_bundle")
    ...
    @property
    @pulumi.getter
    def enforced(self) -> pulumi.Output[builtins.bool]:
        """
        Determines whether Mutual TLS will fail closed (enforced) or fail open. A true value will require a successful Mutual TLS handshake for the connection to continue and will fail closed if unsuccessful. A false value will fail open and allow the connection to proceed (if this attribute is not set we default to `false`).
        """
        return pulumi.get(self, "enforced")
    ...
    @property
    @pulumi.getter(name="tlsActivations")
    def tls_activations(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of alphanumeric strings identifying TLS activations.
        """
        return pulumi.get(self, "tls_activations")
