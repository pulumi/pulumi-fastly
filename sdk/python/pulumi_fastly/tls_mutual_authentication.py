...
class TlsMutualAuthenticationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] include: A comma-separated list used by the Terraform provider during a state refresh to return more data related to your mutual authentication from the Fastly API (permitted values: `tls_activations`).
        :param pulumi.Input[_builtins.str] name: A custom name for your mutual authentication. If name is not supplied we will auto-generate one.
        """
    ...
    def cert_bundle(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @cert_bundle.setter
    def cert_bundle(self, value: pulumi.Input[_builtins.str]):
...
class _TlsMutualAuthenticationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] include: A comma-separated list used by the Terraform provider during a state refresh to return more data related to your mutual authentication from the Fastly API (permitted values: `tls_activations`).
        :param pulumi.Input[_builtins.str] name: A custom name for your mutual authentication. If name is not supplied we will auto-generate one.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tls_activations: List of alphanumeric strings identifying TLS activations.
        :param pulumi.Input[_builtins.str] updated_at: Date and time in ISO 8601 format.
        """
        if activation_ids is not None:
            pulumi.set(__self__, "activation_ids", activation_ids)
...
class TlsMutualAuthentication(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="activationIds")
    def activation_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of TLS Activation IDs
        """
        return pulumi.get(self, "activation_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="certBundle")
    def cert_bundle(self) -> pulumi.Output[_builtins.str]:
        """
        One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted.
        """
        return pulumi.get(self, "cert_bundle")
    ...
    @_builtins.property
    @pulumi.getter
    def enforced(self) -> pulumi.Output[_builtins.bool]:
        """
        Determines whether Mutual TLS will fail closed (enforced) or fail open. A true value will require a successful Mutual TLS handshake for the connection to continue and will fail closed if unsuccessful. A false value will fail open and allow the connection to proceed (if this attribute is not set we default to `false`).
        """
        return pulumi.get(self, "enforced")
    ...
    @_builtins.property
    @pulumi.getter(name="tlsActivations")
    def tls_activations(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of alphanumeric strings identifying TLS activations.
        """
        return pulumi.get(self, "tls_activations")
