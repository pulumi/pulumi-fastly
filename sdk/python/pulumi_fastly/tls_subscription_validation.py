...
class TlsSubscriptionValidationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The ID of the TLS Subscription that should be validated.
        """
...
class TlsSubscriptionValidation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsSubscriptionValidation':
        """
