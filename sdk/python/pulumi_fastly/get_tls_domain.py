...
class GetTlsDomainResult:
    ...
    def tls_activation_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def tls_certificate_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def tls_subscription_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_tls_domain(domain: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain: Domain name to look up activations, certificates and subscriptions for.
    """
    __args__ = dict()
