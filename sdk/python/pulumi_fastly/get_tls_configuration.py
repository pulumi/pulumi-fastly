...
class GetTlsConfigurationResult:
    ...
    def http_protocols(self) -> Sequence[_builtins.str]:
        """
    ...
    def tls_service(self) -> _builtins.str:
        """
...
def get_tls_configuration(default: Optional[_builtins.bool] = None,
                          http_protocols: Optional[Sequence[_builtins.str]] = None,
                          id: Optional[_builtins.str] = None,
                          name: Optional[_builtins.str] = None,
                          tls_protocols: Optional[Sequence[_builtins.str]] = None,
                          tls_service: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool default: Signifies whether Fastly will use this configuration as a default when creating a new TLS activation.
    :param Sequence[_builtins.str] http_protocols: HTTP protocols available on the TLS configuration.
    :param _builtins.str id: ID of the TLS configuration obtained from the Fastly API or another data source. Conflicts with all the other filters.
    :param _builtins.str name: Custom name of the TLS configuration.
    :param Sequence[_builtins.str] tls_protocols: TLS protocols available on the TLS configuration.
    :param _builtins.str tls_service: Whether the configuration should support the `PLATFORM` or `CUSTOM` TLS service.
    """
    __args__ = dict()
