...
class GetTlsConfigurationResult:
    ...
    def http_protocols(self) -> Sequence[builtins.str]:
        """
    ...
    def tls_protocols(self) -> Sequence[builtins.str]:
        """
    ...
    def tls_service(self) -> builtins.str:
        """
...
def get_tls_configuration(default: Optional[builtins.bool] = None,
                          http_protocols: Optional[Sequence[builtins.str]] = None,
                          id: Optional[builtins.str] = None,
                          name: Optional[builtins.str] = None,
                          tls_protocols: Optional[Sequence[builtins.str]] = None,
                          tls_service: Optional[builtins.str] = None,
    ...
    :param builtins.bool default: Signifies whether Fastly will use this configuration as a default when creating a new TLS activation.
    :param Sequence[builtins.str] http_protocols: HTTP protocols available on the TLS configuration.
    :param builtins.str id: ID of the TLS configuration obtained from the Fastly API or another data source. Conflicts with all the other filters.
    :param builtins.str name: Custom name of the TLS configuration.
    :param Sequence[builtins.str] tls_protocols: TLS protocols available on the TLS configuration.
    :param builtins.str tls_service: Whether the configuration should support the `PLATFORM` or `CUSTOM` TLS service.
    """
    __args__ = dict()
...
def get_tls_configuration_output(default: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 http_protocols: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 tls_protocols: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 tls_service: Optional[pulumi.Input[Optional[builtins.str]]] = None,
