...
def get_tls_platform_certificate(domains: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] domains: Domains that are listed in any certificate's Subject Alternative Names (SAN) list.
    :param builtins.str id: Unique ID assigned to certificate by Fastly. Conflicts with all the other filters.
    """
    __args__ = dict()
...
def get_tls_platform_certificate_output(domains: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
