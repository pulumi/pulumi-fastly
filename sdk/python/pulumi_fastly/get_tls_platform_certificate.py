...
def get_tls_platform_certificate(domains: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] domains: Domains that are listed in any certificate's Subject Alternative Names (SAN) list.
    :param _builtins.str id: Unique ID assigned to certificate by Fastly. Conflicts with all the other filters.
    """
    __args__ = dict()
