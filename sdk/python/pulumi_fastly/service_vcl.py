...
class ServiceVclArgs:
    def __init__(__self__, *,
                 ...
                 http3: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 stage: Optional[pulumi.Input[builtins.bool]] = None,
                 stale_if_error: Optional[pulumi.Input[builtins.bool]] = None,
                 stale_if_error_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 vcls: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclVclArgs']]]] = None,
                 version_comment: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] activate: Conditionally prevents new service versions from being activated. The apply step will create a new draft version but
               will not activate it if this is set to `false`. Default `true`
        :param pulumi.Input[builtins.str] default_host: The default hostname
        :param pulumi.Input[builtins.int] default_ttl: The default Time-to-live (TTL) for requests
        :param pulumi.Input[builtins.bool] force_destroy: Services that are active cannot be destroyed. In order to destroy the Service, set `force_destroy` to `true`. Default
               `false`
        :param pulumi.Input[builtins.bool] http3: Enables support for the HTTP/3 (QUIC) protocol
        :param pulumi.Input[builtins.str] name: The unique name for the Service to create
        :param pulumi.Input[builtins.bool] stage: Conditionally enables new service versions to be staged. If `set` to true, all changes made by an `apply` step will be
               staged, even if `apply` did not create a new draft version. Default `false`
        :param pulumi.Input[builtins.bool] stale_if_error: Enables serving a stale object if there is an error
        :param pulumi.Input[builtins.int] stale_if_error_ttl: The default time-to-live (TTL) for serving the stale object for the version
        :param pulumi.Input[builtins.str] version_comment: Description field for the version
        """
    ...
    @property
    @pulumi.getter
    def http3(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @http3.setter
    def http3(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def stage(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @stage.setter
    def stage(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "stage", value)

    @property
    @pulumi.getter(name="staleIfError")
    def stale_if_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stale_if_error(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "stale_if_error", value)

    @property
    @pulumi.getter(name="staleIfErrorTtl")
    def stale_if_error_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def stale_if_error_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def version_comment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def version_comment(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServiceVclState:
    def __init__(__self__, *,
                 acls: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclAclArgs']]]] = None,
                 activate: Optional[pulumi.Input[builtins.bool]] = None,
                 active_version: Optional[pulumi.Input[builtins.int]] = None,
                 backends: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclBackendArgs']]]] = None,
                 cache_settings: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclCacheSettingArgs']]]] = None,
                 ...
                 dynamicsnippets: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclDynamicsnippetArgs']]]] = None,
                 force_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 force_refresh: Optional[pulumi.Input[builtins.bool]] = None,
                 gzips: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclGzipArgs']]]] = None,
                 headers: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclHeaderArgs']]]] = None,
                 healthchecks: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclHealthcheckArgs']]]] = None,
                 http3: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 snippets: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclSnippetArgs']]]] = None,
                 stage: Optional[pulumi.Input[builtins.bool]] = None,
                 staged_version: Optional[pulumi.Input[builtins.int]] = None,
                 stale_if_error: Optional[pulumi.Input[builtins.bool]] = None,
                 stale_if_error_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 vcls: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceVclVclArgs']]]] = None,
                 version_comment: Optional[pulumi.Input[builtins.str]] = None):
        ...
        :param pulumi.Input[builtins.bool] activate: Conditionally prevents new service versions from being activated. The apply step will create a new draft version but
               will not activate it if this is set to `false`. Default `true`
        :param pulumi.Input[builtins.int] active_version: The currently active version of your Fastly Service
        :param pulumi.Input[builtins.int] cloned_version: The latest cloned version by the provider
        :param pulumi.Input[builtins.str] default_host: The default hostname
        :param pulumi.Input[builtins.int] default_ttl: The default Time-to-live (TTL) for requests
        :param pulumi.Input[Sequence[pulumi.Input['ServiceVclDomainArgs']]] domains: A set of Domain names to serve as entry points for your Service
        :param pulumi.Input[builtins.bool] force_destroy: Services that are active cannot be destroyed. In order to destroy the Service, set `force_destroy` to `true`. Default
               `false`
        :param pulumi.Input[builtins.bool] http3: Enables support for the HTTP/3 (QUIC) protocol
        :param pulumi.Input[builtins.bool] imported: Used internally by the provider to temporarily indicate if the service is being imported, and is reset to false once the
               import is finished
        :param pulumi.Input[builtins.str] name: The unique name for the Service to create
        :param pulumi.Input[builtins.bool] stage: Conditionally enables new service versions to be staged. If `set` to true, all changes made by an `apply` step will be
               staged, even if `apply` did not create a new draft version. Default `false`
        :param pulumi.Input[builtins.int] staged_version: The currently staged version of your Fastly Service
        :param pulumi.Input[builtins.bool] stale_if_error: Enables serving a stale object if there is an error
        :param pulumi.Input[builtins.int] stale_if_error_ttl: The default time-to-live (TTL) for serving the stale object for the version
        :param pulumi.Input[builtins.str] version_comment: Description field for the version
        """
    ...
    def active_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def active_version(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def force_refresh(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "force_refresh")

    @force_refresh.setter
    def force_refresh(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def staged_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def staged_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ServiceVcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stale_if_error_ttl: Optional[pulumi.Input[builtins.int]] = None,
            vcls: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServiceVclVclArgs', 'ServiceVclVclArgsDict']]]]] = None,
            version_comment: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceVcl':
        """
    ...
    @property
    @pulumi.getter(name="activeVersion")
    def active_version(self) -> pulumi.Output[builtins.int]:
        """
        The currently active version of your Fastly Service
        """
        return pulumi.get(self, "active_version")
    ...
    @property
    @pulumi.getter(name="defaultHost")
    def default_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default hostname
        """
        return pulumi.get(self, "default_host")
    ...
    @property
    @pulumi.getter(name="forceRefresh")
    def force_refresh(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "force_refresh")
    ...
    @property
    @pulumi.getter
    def http3(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables support for the HTTP/3 (QUIC) protocol
        """
        return pulumi.get(self, "http3")
    ...
    @property
    @pulumi.getter
    def reuse(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "reuse")
    ...
    @property
    @pulumi.getter
    def stage(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Conditionally enables new service versions to be staged. If `set` to true, all changes made by an `apply` step will be
        staged, even if `apply` did not create a new draft version. Default `false`
        """
    ...
    @property
    @pulumi.getter(name="stagedVersion")
    def staged_version(self) -> pulumi.Output[builtins.int]:
        """
        The currently staged version of your Fastly Service
        """
        return pulumi.get(self, "staged_version")
    ...
    @property
    @pulumi.getter(name="staleIfError")
    def stale_if_error(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables serving a stale object if there is an error
        """
        return pulumi.get(self, "stale_if_error")
    ...
    @property
    @pulumi.getter(name="staleIfErrorTtl")
    def stale_if_error_ttl(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The default time-to-live (TTL) for serving the stale object for the version
        """
        return pulumi.get(self, "stale_if_error_ttl")
    ...
    @property
    @pulumi.getter(name="versionComment")
    def version_comment(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Description field for the version
        """
        return pulumi.get(self, "version_comment")
