...
class ServiceVclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] activate: Conditionally prevents the Service from being activated. The apply step will continue to create a new draft version but
