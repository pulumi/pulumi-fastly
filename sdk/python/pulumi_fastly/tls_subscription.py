...
class TlsSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_authority: The entity that issues and certifies the TLS certificates for your subscription. Valid values are `lets-encrypt` or `globalsign`.
        ...
        :param pulumi.Input[builtins.bool] force_destroy: Always delete subscription, even when active domains are present. Defaults to false.
        ...
        :param pulumi.Input[builtins.bool] force_update: Always update subscription, even when active domains are present. Defaults to false.
        """
