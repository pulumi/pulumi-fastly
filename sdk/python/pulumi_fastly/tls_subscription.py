...
class TlsSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_authority: The entity that issues and certifies the TLS certificates for your subscription. Valid values are `lets-encrypt`, `globalsign` or `certainly`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: List of domains on which to enable TLS.
        :param pulumi.Input[builtins.str] common_name: The common name associated with the subscription generated by Fastly TLS. If you do not pass a common name on create, we will default to the first TLS domain included. If provided, the domain chosen as the common name must be included in TLS domains.
        :param pulumi.Input[builtins.str] configuration_id: The ID of the set of TLS configuration options that apply to the enabled domains on this subscription.
        :param pulumi.Input[builtins.bool] force_destroy: Force delete the subscription even if it has active domains. Warning: this can disable production traffic if used incorrectly. Defaults to false.
        :param pulumi.Input[builtins.bool] force_update: Force update the subscription even if it has active domains. Warning: this can disable production traffic if used incorrectly.
        """
...
class _TlsSubscriptionState:
    def __init__(__self__, *,
                 ...
                 force_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 force_update: Optional[pulumi.Input[builtins.bool]] = None,
                 managed_dns_challenge: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] certificate_authority: The entity that issues and certifies the TLS certificates for your subscription. Valid values are `lets-encrypt`, `globalsign` or `certainly`.
        :param pulumi.Input[builtins.str] certificate_id: The certificate ID associated with the subscription.
        :param pulumi.Input[builtins.str] common_name: The common name associated with the subscription generated by Fastly TLS. If you do not pass a common name on create, we will default to the first TLS domain included. If provided, the domain chosen as the common name must be included in TLS domains.
        :param pulumi.Input[builtins.str] configuration_id: The ID of the set of TLS configuration options that apply to the enabled domains on this subscription.
        :param pulumi.Input[builtins.str] created_at: Timestamp (GMT) when the subscription was created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: List of domains on which to enable TLS.
        :param pulumi.Input[builtins.bool] force_destroy: Force delete the subscription even if it has active domains. Warning: this can disable production traffic if used incorrectly. Defaults to false.
        :param pulumi.Input[builtins.bool] force_update: Force update the subscription even if it has active domains. Warning: this can disable production traffic if used incorrectly.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] managed_dns_challenge: The details required to configure DNS to respond to ACME DNS challenge in order to verify domain ownership.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the subscription. The list of possible states are: `pending`, `processing`, `issued`, and `renewing`.
        :param pulumi.Input[builtins.str] updated_at: Timestamp (GMT) when the subscription was updated.
        """
    ...
    def managed_dns_challenge(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def managed_dns_challenge(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class TlsSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'TlsSubscription':
        """
    ...
    @pulumi.getter(name="managedDnsChallenge")
    @_utilities.deprecated("""Use 'managed_dns_challenges' attribute instead""")
    def managed_dns_challenge(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The details required to configure DNS to respond to ACME DNS challenge in order to verify domain ownership.
        """
        return pulumi.get(self, "managed_dns_challenge")
