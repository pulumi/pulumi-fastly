...
class _TlsSubscriptionState:
    def __init__(__self__, *,
                 ...
                 managed_dns_challenges: pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedDnsChallengeArgs']]]] = None,
                 managed_http_challenges: pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedHttpChallengeArgs']]]] = None,
    ...
    def managed_dns_challenge(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
    ...
    def managed_dns_challenge(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "managed_dns_challenge", value)

    @_builtins.property
    @pulumi.getter(name="managedDnsChallenges")
    def managed_dns_challenges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedDnsChallengeArgs']]]]:
        """
    ...
    def managed_dns_challenges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedDnsChallengeArgs']]]]):
        pulumi.set(self, "managed_dns_challenges", value)

    @_builtins.property
    @pulumi.getter(name="managedHttpChallenges")
    def managed_http_challenges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedHttpChallengeArgs']]]]:
        """
    ...
    def managed_http_challenges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TlsSubscriptionManagedHttpChallengeArgs']]]]):
    ...
    def __init__(__self__,
        ...
        **Configuring an apex and a wildcard domain:**
        ...
        def create_domain_validation(range_body):
            for domain_validation_range in [{"key": k, "value": v} for [k, v] in sorted((range_body).items())]:
                domain_validation[domain_validation_range['key']] = aws.Route53Record(f"domain_validation-{domain_validation_range['key']}",
                    name=domain_validation_range.value[0].record_name,
                    type=domain_validation_range.value[0].record_type,
                    zone_id=production.zone_id,
                    allow_overwrite=True,
                    records=[domain_validation_range.value[0].record_value],
                    ttl=60,
                    opts = pulumi.ResourceOptions(depends_on=[example_tls_subscription]))
