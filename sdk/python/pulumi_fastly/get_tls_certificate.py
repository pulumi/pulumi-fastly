...
def get_tls_certificate(domains: Optional[Sequence[builtins.str]] = None,
                        id: Optional[builtins.str] = None,
                        issued_to: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] domains: Domains that are listed in any certificates' Subject Alternative Names (SAN) list.
    :param builtins.str id: Unique ID assigned to certificate by Fastly
    :param builtins.str issued_to: The hostname for which a certificate was issued.
    :param builtins.str issuer: The certificate authority that issued the certificate.
    :param builtins.str name: Human-readable name used to identify the certificate. Defaults to the certificate's Common Name or first Subject Alternative Name entry.
    """
    __args__ = dict()
...
def get_tls_certificate_output(domains: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               issued_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
