...
def get_tls_activation_ids(certificate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_id: ID of TLS certificate used to filter activations
    """
    __args__ = dict()
