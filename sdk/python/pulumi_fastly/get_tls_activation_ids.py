...
def get_tls_activation_ids(certificate_id: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_id: ID of TLS certificate used to filter activations
    """
    __args__ = dict()
...
def get_tls_activation_ids_output(certificate_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
