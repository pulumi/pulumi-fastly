...
class ServiceAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permission: The permissions to grant the user. Can be `full`, `read_only`, `purge_select` or `purge_all`.
        :param pulumi.Input[builtins.str] service_id: The ID of the service to grant permissions for.
        :param pulumi.Input[builtins.str] user_id: The ID of the user which will receive the granted permissions.
        """
...
class ServiceAuthorization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permission: Optional[pulumi.Input[builtins.str]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceAuthorization':
        """
