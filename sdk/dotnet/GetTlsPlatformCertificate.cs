...
namespace Pulumi.Fastly
{
    public static class GetTlsPlatformCertificate
    {
        ...
        /// {
        ///     var example = Fastly.Index.GetTlsPlatformCertificate.Invoke(new()
        ///     {
        ///         Domains = new[]
        ///         {
        ///             "example.com",
        ...
        /// ```
        /// </summary>
        public static Output<GetTlsPlatformCertificateResult> Invoke(GetTlsPlatformCertificateInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetTlsPlatformCertificateResult>("fastly:index/getTlsPlatformCertificate:getTlsPlatformCertificate", args ?? new GetTlsPlatformCertificateInvokeArgs(), options.WithDefaults());
    }
