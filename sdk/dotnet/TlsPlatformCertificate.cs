...
namespace Pulumi.Fastly
{
    ...
    ///     });
    /// 
    ///     var config = Fastly.Index.GetTlsConfiguration.Invoke(new()
    ///     {
    ///         TlsService = "PLATFORM",
    ///     });
    /// 
    ///     var keyTlsPrivateKey = new Fastly.Index.TlsPrivateKey("key", new()
    ///     {
    ///         KeyPem = key.PrivateKeyPem,
    ///         Name = "tf-demo",
    ///     });
    /// 
    ///     var certTlsPlatformCertificate = new Fastly.Index.TlsPlatformCertificate("cert", new()
    ///     {
