...
namespace Pulumi.Fastly.Inputs
{
    ...
    public sealed class NgwafAccountRuleRateLimitArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientIdentifiers", required: true)]
        private InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierArgs>? _clientIdentifiers;

        /// <summary>
        /// List of client identifiers used for rate limiting. Can only be length 1 or 2.
        /// </summary>
        public InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierArgs> ClientIdentifiers
        {
            get => _clientIdentifiers ?? (_clientIdentifiers = new InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierArgs>());
        ...
        public NgwafAccountRuleRateLimitArgs()
        {
        }
        public static new NgwafAccountRuleRateLimitArgs Empty => new NgwafAccountRuleRateLimitArgs();
    }
}
