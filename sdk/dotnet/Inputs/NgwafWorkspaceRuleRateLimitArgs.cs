...
namespace Pulumi.Fastly.Inputs
{
    ...
    public sealed class NgwafWorkspaceRuleRateLimitArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientIdentifiers", required: true)]
        private InputList<Inputs.NgwafWorkspaceRuleRateLimitClientIdentifierArgs>? _clientIdentifiers;

        /// <summary>
        /// List of client identifiers used for rate limiting. Can only be length 1 or 2.
        /// </summary>
        public InputList<Inputs.NgwafWorkspaceRuleRateLimitClientIdentifierArgs> ClientIdentifiers
        {
            get => _clientIdentifiers ?? (_clientIdentifiers = new InputList<Inputs.NgwafWorkspaceRuleRateLimitClientIdentifierArgs>());
        ...
        public NgwafWorkspaceRuleRateLimitArgs()
        {
        }
        public static new NgwafWorkspaceRuleRateLimitArgs Empty => new NgwafWorkspaceRuleRateLimitArgs();
    }
}
