...
namespace Pulumi.Fastly.Inputs
{
    ...
    public sealed class NgwafAccountRuleRateLimitGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientIdentifiers", required: true)]
        private InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierGetArgs>? _clientIdentifiers;

        /// <summary>
        /// List of client identifiers used for rate limiting. Can only be length 1 or 2.
        /// </summary>
        public InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierGetArgs> ClientIdentifiers
        {
            get => _clientIdentifiers ?? (_clientIdentifiers = new InputList<Inputs.NgwafAccountRuleRateLimitClientIdentifierGetArgs>());
        ...
        public NgwafAccountRuleRateLimitGetArgs()
        {
        }
        public static new NgwafAccountRuleRateLimitGetArgs Empty => new NgwafAccountRuleRateLimitGetArgs();
    }
}
