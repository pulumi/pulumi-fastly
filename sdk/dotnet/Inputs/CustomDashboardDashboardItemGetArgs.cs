...
namespace Pulumi.Fastly.Inputs
{
    ...
    public sealed class CustomDashboardDashboardItemGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An object which describes the data to display.
        /// </summary>
        [Input("dataSource", required: true)]
        public Input<Inputs.CustomDashboardDashboardItemDataSourceGetArgs> DataSource { get; set; } = null!;
        ...
        public Input<Inputs.CustomDashboardDashboardItemVisualizationGetArgs> Visualization { get; set; } = null!;

        public CustomDashboardDashboardItemGetArgs()
        {
        }
        public static new CustomDashboardDashboardItemGetArgs Empty => new CustomDashboardDashboardItemGetArgs();
    }
}
