...
namespace Pulumi.Fastly
{
    public static partial class Invokes
    {
        ...
        public static Task<GetFastlyIpRangesResult> GetFastlyIpRanges(InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFastlyIpRangesResult>("fastly:index/getFastlyIpRanges:getFastlyIpRanges", ResourceArgs.Empty, options.WithVersion());
    }
