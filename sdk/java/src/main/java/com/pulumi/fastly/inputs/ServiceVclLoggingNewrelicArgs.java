...
public final class ServiceVclLoggingNewrelicArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceVclLoggingNewrelicArgs Empty = new ServiceVclLoggingNewrelicArgs();
    ...
    private ServiceVclLoggingNewrelicArgs() {}

    private ServiceVclLoggingNewrelicArgs(ServiceVclLoggingNewrelicArgs $) {
        this.format = $.format;
    ...
    public static Builder builder(ServiceVclLoggingNewrelicArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceVclLoggingNewrelicArgs();
        }

        public Builder(ServiceVclLoggingNewrelicArgs defaults) {
            $ = new ServiceVclLoggingNewrelicArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param format Apache style log formatting. Your log must produce valid JSON that New Relic Logs can ingest.
         * 
         * @return builder
         * 
         */
        ...
        public ServiceVclLoggingNewrelicArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceVclLoggingNewrelicArgs", "name");
            }
            if ($.token == null) {
                throw new MissingRequiredPropertyException("ServiceVclLoggingNewrelicArgs", "token");
            }
            return $;
        }
    }
