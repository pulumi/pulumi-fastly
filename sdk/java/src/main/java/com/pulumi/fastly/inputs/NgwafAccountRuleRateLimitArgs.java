...
import com.pulumi.fastly.inputs.NgwafAccountRuleRateLimitClientIdentifierArgs;
...
public final class NgwafAccountRuleRateLimitArgs extends com.pulumi.resources.ResourceArgs {

    public static final NgwafAccountRuleRateLimitArgs Empty = new NgwafAccountRuleRateLimitArgs();
    ...
    private Output<List<NgwafAccountRuleRateLimitClientIdentifierArgs>> clientIdentifiers;

    /**
     * @return List of client identifiers used for rate limiting. Can only be length 1 or 2.
     * 
     */
    public Output<List<NgwafAccountRuleRateLimitClientIdentifierArgs>> clientIdentifiers() {
    ...
    private NgwafAccountRuleRateLimitArgs() {}

    private NgwafAccountRuleRateLimitArgs(NgwafAccountRuleRateLimitArgs $) {
    ...
    public static Builder builder(NgwafAccountRuleRateLimitArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NgwafAccountRuleRateLimitArgs();
        }

        public Builder(NgwafAccountRuleRateLimitArgs defaults) {
            $ = new NgwafAccountRuleRateLimitArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder clientIdentifiers(Output<List<NgwafAccountRuleRateLimitClientIdentifierArgs>> clientIdentifiers) {
         ...
         * 
         */
        public Builder clientIdentifiers(List<NgwafAccountRuleRateLimitClientIdentifierArgs> clientIdentifiers) {
         ...
         * 
         */
        public Builder clientIdentifiers(NgwafAccountRuleRateLimitClientIdentifierArgs... clientIdentifiers) {
        ...
        public NgwafAccountRuleRateLimitArgs build() {
            if ($.clientIdentifiers == null) {
                throw new MissingRequiredPropertyException("NgwafAccountRuleRateLimitArgs", "clientIdentifiers");
            }
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("NgwafAccountRuleRateLimitArgs", "duration");
            }
            if ($.interval == null) {
                throw new MissingRequiredPropertyException("NgwafAccountRuleRateLimitArgs", "interval");
            }
            if ($.signal == null) {
                throw new MissingRequiredPropertyException("NgwafAccountRuleRateLimitArgs", "signal");
            }
            if ($.threshold == null) {
                throw new MissingRequiredPropertyException("NgwafAccountRuleRateLimitArgs", "threshold");
            }
            return $;
        }
    }
