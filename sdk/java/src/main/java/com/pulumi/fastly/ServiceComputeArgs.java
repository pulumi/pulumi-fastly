...
public final class ServiceComputeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceComputeArgs() {}

    private ServiceComputeArgs(ServiceComputeArgs $) {
    ...
    public static Builder builder(ServiceComputeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceComputeArgs();
        }

        public Builder(ServiceComputeArgs defaults) {
            $ = new ServiceComputeArgs(Objects.requireNonNull(defaults));
        }
