...
public final class ServiceWafConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceWafConfigurationArgs Empty = new ServiceWafConfigurationArgs();
     ...
     * 
     */
    @Import(name="wafId", required=true)
    ...
    private ServiceWafConfigurationArgs() {}

    private ServiceWafConfigurationArgs(ServiceWafConfigurationArgs $) {
    ...
    public static Builder builder(ServiceWafConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceWafConfigurationArgs();
        }

        public Builder(ServiceWafConfigurationArgs defaults) {
            $ = new ServiceWafConfigurationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder wafId(Output<String> wafId) {
            $.wafId = wafId;
            return this;
        }
