...
@CustomType
public final class ServiceVclLoggingDatadog {
    /**
    ...
    public static Builder builder(ServiceVclLoggingDatadog defaults) {
    ...
    public static final class Builder {
        ...
        private String token;
        public Builder() {}
        public Builder(ServiceVclLoggingDatadog defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ServiceVclLoggingDatadog", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder token(String token) {
            if (token == null) {
              throw new MissingRequiredPropertyException("ServiceVclLoggingDatadog", "token");
            }
            this.token = token;
            return this;
        }
