...
@CustomType
public final class ServiceVclLoggingS3 {
    /**
    ...
    public static Builder builder(ServiceVclLoggingS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timestampFormat;
        public Builder() {}
        public Builder(ServiceVclLoggingS3 defaults) {
