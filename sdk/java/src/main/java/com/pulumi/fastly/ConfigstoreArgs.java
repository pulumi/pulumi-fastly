...
public final class ConfigstoreArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConfigstoreArgs Empty = new ConfigstoreArgs();
    ...
    private ConfigstoreArgs() {}

    private ConfigstoreArgs(ConfigstoreArgs $) {
    ...
    public static Builder builder(ConfigstoreArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ConfigstoreArgs defaults) {
            $ = new ConfigstoreArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name A unique name to identify the Config Store. It is important to note that changing this attribute will delete and recreate the Config Store, and discard the current entries. You MUST first delete the associated resourceLink block from your service before modifying this field.
         * 
         * @return builder
         * 
         */
