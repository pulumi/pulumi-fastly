...
public final class ServiceVclLoggingSyslogArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceVclLoggingSyslogArgs Empty = new ServiceVclLoggingSyslogArgs();
    ...
    private ServiceVclLoggingSyslogArgs() {}

    private ServiceVclLoggingSyslogArgs(ServiceVclLoggingSyslogArgs $) {
    ...
    public static Builder builder(ServiceVclLoggingSyslogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceVclLoggingSyslogArgs();
        }

        public Builder(ServiceVclLoggingSyslogArgs defaults) {
            $ = new ServiceVclLoggingSyslogArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param formatVersion The version of the custom logging format. Can be either 1 or 2. (Default: 2)
         * 
         * @return builder
         * 
         */
        ...
        public ServiceVclLoggingSyslogArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("ServiceVclLoggingSyslogArgs", "address");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceVclLoggingSyslogArgs", "name");
            }
            return $;
        }
    }
