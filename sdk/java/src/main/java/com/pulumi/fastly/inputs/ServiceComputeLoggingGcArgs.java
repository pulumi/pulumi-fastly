...
public final class ServiceComputeLoggingGcArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Your Google Cloud Platform service account email address. The `clientEmail` field in your service account authentication JSON. You may optionally provide this via an environment variable, `FASTLY_GCS_EMAIL`.
     * 
     */
    ...
    public static Builder builder(ServiceComputeLoggingGcArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceComputeLoggingGcArgs();
        }
        ...
        /**
         * @param user Your Google Cloud Platform service account email address. The `clientEmail` field in your service account authentication JSON. You may optionally provide this via an environment variable, `FASTLY_GCS_EMAIL`.
         * 
         * @return builder
         * 
         */
        ...
        public ServiceComputeLoggingGcArgs build() {
            if ($.bucketName == null) {
                throw new MissingRequiredPropertyException("ServiceComputeLoggingGcArgs", "bucketName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceComputeLoggingGcArgs", "name");
            }
            return $;
        }
    }
