...
public final class ServiceVclLoggingBigqueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ServiceVclLoggingBigqueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceVclLoggingBigqueryArgs();
        }
        ...
        /**
         * @param format The logging format desired.
         * 
         * @return builder
         * 
         */
