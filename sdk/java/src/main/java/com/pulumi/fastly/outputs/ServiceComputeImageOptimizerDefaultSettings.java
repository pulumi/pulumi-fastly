...
@CustomType
public final class ServiceComputeImageOptimizerDefaultSettings {
    /**
    ...
    public static Builder builder(ServiceComputeImageOptimizerDefaultSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer webpQuality;
        public Builder() {}
        public Builder(ServiceComputeImageOptimizerDefaultSettings defaults) {
        ...
        public ServiceComputeImageOptimizerDefaultSettings build() {
            final var _resultValue = new ServiceComputeImageOptimizerDefaultSettings();
