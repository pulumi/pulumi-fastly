...
public class Configstore extends com.pulumi.resources.CustomResource {
     ...
     */
    public Configstore(java.lang.String name, @Nullable ConfigstoreArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Configstore(java.lang.String name, @Nullable ConfigstoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fastly:index/configstore:Configstore", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Configstore(java.lang.String name, Output<java.lang.String> id, @Nullable ConfigstoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fastly:index/configstore:Configstore", name, state, makeResourceOptions(options, id), false);
    }

    private static ConfigstoreArgs makeArgs(@Nullable ConfigstoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ConfigstoreArgs.Empty : args;
    }
     ...
     */
    public static Configstore get(java.lang.String name, Output<java.lang.String> id, @Nullable ConfigstoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
