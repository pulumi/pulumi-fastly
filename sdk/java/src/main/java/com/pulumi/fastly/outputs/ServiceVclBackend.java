...
public final class ServiceVclBackend {
    ...
    public static final class Builder {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("ServiceVclBackend", "address");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ServiceVclBackend", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public ServiceVclBackend build() {
            final var _resultValue = new ServiceVclBackend();
            _resultValue.address = address;
            _resultValue.autoLoadbalance = autoLoadbalance;
