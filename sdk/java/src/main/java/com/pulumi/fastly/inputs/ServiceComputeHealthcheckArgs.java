...
public final class ServiceComputeHealthcheckArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceComputeHealthcheckArgs Empty = new ServiceComputeHealthcheckArgs();
    ...
    private ServiceComputeHealthcheckArgs() {}

    private ServiceComputeHealthcheckArgs(ServiceComputeHealthcheckArgs $) {
    ...
    public static Builder builder(ServiceComputeHealthcheckArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceComputeHealthcheckArgs();
        }

        public Builder(ServiceComputeHealthcheckArgs defaults) {
            $ = new ServiceComputeHealthcheckArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceComputeHealthcheckArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("ServiceComputeHealthcheckArgs", "host");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceComputeHealthcheckArgs", "name");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("ServiceComputeHealthcheckArgs", "path");
            }
            return $;
        }
    }
