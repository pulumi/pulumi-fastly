...
public class TlsMutualAuthentication extends com.pulumi.resources.CustomResource {
     ...
     */
    public TlsMutualAuthentication(java.lang.String name) {
     ...
     */
    public TlsMutualAuthentication(java.lang.String name, TlsMutualAuthenticationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TlsMutualAuthentication(java.lang.String name, TlsMutualAuthenticationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fastly:index/tlsMutualAuthentication:TlsMutualAuthentication", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TlsMutualAuthentication(java.lang.String name, Output<java.lang.String> id, @Nullable TlsMutualAuthenticationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("fastly:index/tlsMutualAuthentication:TlsMutualAuthentication", name, state, makeResourceOptions(options, id), false);
    }

    private static TlsMutualAuthenticationArgs makeArgs(TlsMutualAuthenticationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TlsMutualAuthenticationArgs.Empty : args;
    }
     ...
     */
    public static TlsMutualAuthentication get(java.lang.String name, Output<java.lang.String> id, @Nullable TlsMutualAuthenticationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
