...
public final class ServiceVclConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ServiceVclConditionArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceVclConditionArgs", "name");
            }
            if ($.statement == null) {
                throw new MissingRequiredPropertyException("ServiceVclConditionArgs", "statement");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ServiceVclConditionArgs", "type");
            }
            return $;
        }
    }
