...
public final class ServiceComputeBackendArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceComputeBackendArgs Empty = new ServiceComputeBackendArgs();
    ...
    private ServiceComputeBackendArgs() {}
    ...
    public static Builder builder(ServiceComputeBackendArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceComputeBackendArgs();
        }

        public Builder(ServiceComputeBackendArgs defaults) {
            $ = new ServiceComputeBackendArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceComputeBackendArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("ServiceComputeBackendArgs", "address");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceComputeBackendArgs", "name");
            }
            return $;
        }
    }
