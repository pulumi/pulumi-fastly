...
# Use gotestsum in CI (GitHub Actions) for better formatted output, otherwise use go test
...
PROVIDER_VERSION ?= 11.0.0-alpha.0+dev
...
# `cmd/pulumi-resource-fastly/schema.json` is valid and up to date.
